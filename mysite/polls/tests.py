...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        :return:
        """
        time = timezone.now() - datetime.timedelta(hours=21, minutes=59, seconds=59)
    ...
    def test_future_question_and_past_qestion(self):
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future(self):
        """
        The detail view of a question with a pub_date in the future reurns a 404 not found.
        :return:
        """
